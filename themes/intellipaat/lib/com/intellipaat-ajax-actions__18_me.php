...
global $current_user;
	...
	$result_crm = json_encode($_REQUEST);
	$result_crm .= json_encode($all_meta_for_user);
	$result_crm .= json_encode($all_meta_for_user['billing_phone'][0]);
	$friends = 'kovitsv@gmail.com'; 
   wp_mail( $friends, "Lead Create New", 'I just put something on my blog:test me'.$result_crm);
