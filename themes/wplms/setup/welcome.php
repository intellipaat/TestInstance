...
class WPLMS_Admin_Welcome {
	...
	public function admin_css() {
		wp_enqueue_style( 'vibe-activation', VIBE_URL.'/css/activation.css');
	}
	...
	private function intro() {
		...
		*/
		...
		<p class="wplms-actions">
			...
			<a href="<?php echo esc_url( 'http://support.vibethemes.com/solution/categories/1000126528/folders/1000210638'); ?>" class="docs button"><?php _e( 'FAQs', 'vibe' ); ?></a>
			<a href="<?php echo esc_url( 'http://vibethemes.com/envato/wplms/documentation/'); ?>" class="docs button"><?php _e( 'Docs', 'vibe' ); ?></a>
			<a href="<?php echo esc_url( 'http://support.vibethemes.com/solution/categories/1000126528/folders/1000210637'); ?>" class="button"><?php _e( 'Customization Tips', 'vibe' ); ?></a>
			<a href="<?php echo esc_url( 'http://support.vibethemes.com/'); ?>" class="button"><?php _e( 'Support system', 'vibe' ); ?></a>
		</p>
		...
		<h2 class="nav-tab-wrapper">
			...
			</a><a class="nav-tab <?php if ( $_GET['page'] == 'wplms-system' ) echo 'nav-tab-active'; ?>" href="<?php echo esc_url( admin_url( add_query_arg( array( 'page' => 'wplms-system' ), 'index.php' ) ) ); ?>">
				<?php _e( 'System Status', 'vibe' ); ?>
	...
	public function install_screen() {
		...
		<div class="wrap wplms-wrap about-wrap">
			...
			<div class="changelog about-integrations">
				...
				<iframe width="100%" height="480" src="http://www.youtube.com/embed/HURLXtbfKVY" frameborder="0" allowfullscreen></iframe>
			</div>
			<div class="changelog">
				<div class="feature-section col three-col">
					<div>
						...
						<a href="<?php echo admin_url( 'index.php?page=wplms-system' ); ?>"><?php _e( 'WPLMS System Status', 'vibe' ); ?></a><br />
					...
					<div>
						...
						<p><a href="http://vibethemes.com/forums/forum/wordpress-html-css/wordpress-themes/wplms/tips-tricks-docs/7313-wplms-faqs"><?php _e( 'White screen when installed', 'vibe' ); ?></a><br />
						<a href="http://vibethemes.com/forums/forum/wordpress-html-css/wordpress-themes/wplms/tips-tricks-docs/33413-how-to-resolve-page-not-opening-blank-page-or-404-errors-in-wplms"><?php _e( 'Course pages not opening', 'vibe' ); ?></a><br />
						<a href="http://vibethemes.com/forums/forum/wordpress-html-css/wordpress-themes/wplms/tips-tricks-docs/33413-how-to-resolve-page-not-opening-blank-page-or-404-errors-in-wplms"><?php _e( 'Getting 404 pages', 'vibe' ); ?></a><br />
						<a href="http://vibethemes.com/forums/forum/wordpress-html-css/wordpress-themes/wplms/tips-tricks-docs/33415-fix-take-this-course-page-not-working"><?php _e( 'Start Course/Take this Course not working', 'vibe' ); ?></a><br />
						</p>
					</div>
					<div class="last-feature">
						<h4><?php _e( 'Other popular issues', 'vibe' ); ?></h4>
						<p><?php _e( 'Following is the list of most frequent issues faced by users', 'vibe' ); ?></p>
						<p><a href="http://vibethemes.com/forums/forum/wordpress-html-css/wordpress-themes/wplms/31272-my-quiz-answer-is-not-getting-saved"><?php _e( 'Quizzes not saving answers', 'vibe' ); ?></a><br />
						<a href="http://vibethemes.com/forums/forum/wordpress-html-css/wordpress-themes/wplms/16160-update-error-wpbakery-visual-composer"><?php _e( 'Visual composer not updating', 'vibe' ); ?></a><br />
						<a href="http://vibethemes.com/forums/forum/wordpress-html-css/wordpress-themes/wplms/tips-tricks-docs/33413-how-to-resolve-page-not-opening-blank-page-or-404-errors-in-wplms"><?php _e( 'Getting 404 page on editing course', 'vibe' ); ?></a><br />
						<a href="http://vibethemes.com/forums/forum/wordpress-html-css/wordpress-themes/wplms/tips-tricks-docs/33414-how-to-fix-theme-customizer-not-working"><?php _e( 'Theme customizer not working', 'vibe' ); ?></a><br />
						</p>
					</div>
				</div>
			</div>
			<div class="return-to-dashboard">
				<a href="http://support.vibethemes.com/"><?php _e( 'Unable to setup ? Get help on our Support forums.', 'vibe' ); ?></a>
			</div>
		</div>
		<?php
	}
	...
	public function about_screen() {
		...
		<div class="wrap wplms-wrap about-wrap">
			...
			<div class="changelog">
				<div class="wplms-feature feature-rest feature-section col two-col">
					<div class="col-1">
						<h4><?php _e( '30 bug fixes', 'vibe' ); ?></h4>
						<p><?php _e( 'We fixed some pending issues. Refer to change log for complete list of issues/bugs fixed in the update.', 'vibe' ); ?></p>
						<a href="http://support.vibethemes.com/solution/categories/1000126528/folders/1000210639/articles/1000197407-1-9-7" class="button"><?php _e( 'Check issue log ', 'vibe' ); ?></a>
					</div>
					<div class="col-2">
						<h4><?php _e( 'Bug Fixes Update', 'vibe' ); ?></h4>
						<p><?php _e( 'We focussed on Bug fixing in this update. Single Quiz was revamped with new structure. Architechtural improvements were made for coming updates.', 'vibe' ); ?></p>
						<a href="http://support.vibethemes.com/solution/categories/1000126528/folders/1000210639/articles/1000197407-1-9-7" class="button"><?php _e( 'Check update log ', 'vibe' ); ?></a>
					</div>
				</div>
			</div>
			<div class="changelog about-integrations">
				...
				<div class="wplms-feature feature-section col three-col">
					...
					<div class="last-feature">
						<h4><?php _e( 'BP Social Connect', 'vibe' ); ?></h4>
						<p><img src="<?php echo VIBE_URL.'/setup/data/uploads/new/bp_social_connect.png'; ?>" /></p>
						<a href="https://wordpress.org/plugins/bp-social-connect/" class="button">Download</a>
					</div>
				</div>
			</div>
			<div class="changelog">
