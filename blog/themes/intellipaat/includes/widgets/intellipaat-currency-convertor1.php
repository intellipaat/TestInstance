...
class IntellipatCurrencyConvertor extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		echo '<select id="curreny_convertor" name="curreny_convertor" title="To pay in INR currency, You have fill your billing addresss from India. Other than Indian billing address can pay in  USD currency">
			...
			jQuery(document).ready(function($){
				...
				jQuery( document ).ajaxComplete(function() {
					if(jQuery("#billing_country").val()=='IN' && jQuery("#billing_country").prop('disabled') == false)
						...
						add_curreny_span();
						switch_currency(jQuery("#curreny_convertor").val(), 1);
