...
<div id="loginwrapper" class="loginwrapper row">
	<div class="col-md-12">
	...
	<div class="col-md-6 col-sm-6 col-sm-offset-1 col-md-offset-1">
		<div class="login" id="theme-my-login<?php $template->the_instance(); ?>">
            <form name="loginform" id="loginform<?php $template->the_instance(); ?>" action="<?php $template->the_action_url( 'login' ); ?>" method="post">
                ...
                <p class="submit">
                    <input type="submit" name="wp-submit" id="wp-submit<?php $template->the_instance(); ?>" value="<?php esc_attr_e( 'Log In', 'theme-my-login' ); ?>" class="button" />
                    <input type="hidden" name="redirect_to" value="<?php echo isset($_REQUEST['redirect_to']) ? $_REQUEST['redirect_to'] : $template->the_redirect_url( 'login' ) ; ?>" />
