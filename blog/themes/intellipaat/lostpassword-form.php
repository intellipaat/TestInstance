...
<div class="container">
	<div class="row">
        <div class="login col-md-8 col-md-offset-2" id="theme-my-login<?php $template->the_instance(); ?>">
            ...
            <form name="lostpasswordform" id="lostpasswordform<?php $template->the_instance(); ?>" action="<?php $template->the_action_url( 'lostpassword' ); ?>" method="post">
                ...
                <p class="submit">
                    <input type="submit" name="wp-submit" id="wp-submit<?php $template->the_instance(); ?>" value="<?php esc_attr_e( 'Get New Password', 'theme-my-login' ); ?>" class="button" />
