    		...
    		<div class="col-md-9">
    			<div class="content">
    				<?php
						...
						$link = get_post_meta(get_the_ID(), 'intellipaat-post-href', true);
						if(!$link)
							$link =site_url('media');
                           ...
                           echo ' <div class="blogpost">
                                ...
                                <div class="featured">
                                    <a rel="nofollow noindex" href="'.$link.'">'.get_the_post_thumbnail(get_the_ID(),'full').'</a>
                                </div>':'').'
                                <div class="excerpt '.(has_post_thumbnail(get_the_ID())?'thumb':'').'">
                                    <h3><a href="'.$link.'" rel="nofollow noindex">'.get_the_title().'</a></h3>
                                    <div class="cats">
                                        '.$cats.'
                                        <p>
                                        </p>
                                    ...
                                    <p>'.get_the_excerpt().'</p>
                                    <a rel="nofollow noindex" href="'.$link.'" class="link">'.__('Read More','vibe').'</a>
                                </div>
                            </div>';
                        endwhile;
                        endif;
