	...
	<tbody>	
    	<tr>
        	<td>
                ...
                <?php if ( $user_pass /*get_option( 'woocommerce_registration_generate_password' ) == 'yes' && $password_generated */) : ?>
                
                    <p><?php printf( __( "Your password : <strong>%s</strong>", 'woocommerce' ), esc_html( $user_pass ) ); ?></p>
