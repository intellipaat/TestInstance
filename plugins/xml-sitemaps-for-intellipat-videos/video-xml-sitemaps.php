<?php
/*
Plugin Name: Intellipaat XML Sitemap for Videos
Plugin URI: http://www.makarandmane.com/portfolio/
Description: This plugin will generate a XML Video Sitemap for your Intellipaat website. Open the <a href="tools.php?page=video-sitemap-generate-page">settings page</a> to create your video sitemap.
Author: Makarand Mane
Version:3.0
Author URI: http://www.makarandmane.com/about/
*/
...
<div class="wrap"> 
  ...
  <div style="width:800px; padding:10px 20px; background-color:#eee; font-size:.95em; font-family:Georgia;margin:20px">
    ...
    <p>This WordPress Plugin is written by <a href="http://www.labnol.org/about/">Amit Agarwal</a> , and modified by <a href="http://www.makarandmane.com/">Makarand Mane</a> for <a href="https://intellipaat.com">Intellipaat</a>. </p>
  </div>
</div>
<?php    }
}
...
function video_sitemap_loop () {
    ...
    AND (post_type = 'post' OR post_type = 'page' OR post_type = 'course')
    AND post_content LIKE '%videothumb%' 
    ...
    if (empty ($posts)) {
        ...
        $xml .= '<!-- Created by (http://www.makarandmane.com/) -->' . "\n";
        $xml .= '<!-- Generated-on="' . date("F j, Y, g:i a") .'" -->' . "\n";             
        $xml .= '<?xml-stylesheet type="text/xsl" href="' . get_bloginfo('wpurl') . '/wp-content/plugins/xml-sitemaps-for-intellipat-videos/video-sitemap.xsl"?>' . "\n" ;        
        ...
        foreach ($posts as $post) {
            ...
            if (preg_match_all ("/youtube.com\/(v\/|watch\?v=|embed\/)([a-zA-Z0-9\-_]*)/", apply_filters('the_content', apply_filters('the_content',$post->post_content)), $matches, PREG_SET_ORDER)) {
