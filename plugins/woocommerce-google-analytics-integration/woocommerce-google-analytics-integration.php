<?php
/**
 * Plugin Name: WooCommerce Google Analytics Integration Modified
 * Plugin URI: http://makarandmane.com/plugins/woocommerce-google-analytics-integration/
 * Description: Allows Google Analytics tracking code to be inserted into WooCommerce store pages.
 * Author: Makarand Mane
 * Author URI: http://makarandmane.com/about
 * Version: 1.5.0
