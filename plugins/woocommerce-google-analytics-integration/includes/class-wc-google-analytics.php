...
class WC_Google_Analytics extends WC_Integration {
	...
	public function __construct() {
		...
		// Tracking code
		add_action( 'wp_head', array( $this, 'tracking_code_display' ), 9999 );
	...
	ga('create', '" . esc_js( $this->ga_id ) . "', '" . $set_domain_name . "', {'allowLinker': true});
	ga('require', 'linker');
	ga('linker:autoLink', ['intellipaat.in', 'intellipaat.uk'] );" .
	$support_display_advertising .
	$anonymize_enabled . "
